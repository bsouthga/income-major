...
var _plotsJs = require("./plots.js");

var _plotsJs2 = _interopRequireDefault(_plotsJs);

require("babel/polyfill");

(0, _plotsJs2["default"])();

},{"./plots.js":100,"babel/polyfill":92}],2:[function(require,module,exports){
(function (global){
"use strict";
...
},{"_process":93}],91:[function(require,module,exports){
...
},{"./textures.js":97}],97:[function(require,module,exports){
...
var _curlyBraceJs = require("./curlyBrace.js");

var _curlyBraceJs2 = _interopRequireDefault(_curlyBraceJs);
...
var incomeChart = (function () {
  function incomeChart(_ref) {
    ...
    this.data = data;
    this.id = id;
    this.container = _d32["default"].select(id);
  ...
  _createClass(incomeChart, [{
    ...
    value: function draw() {
      ...
      var categories = Array.from(new Set(income.map(function (x) {
        return x.category;
      })));
      ...
      var totalN = income.reduce(function (s, d) {
        return s + d.n;
      }, 0);

      var fixedBarHeight = height / income.length;

      var variableBarHeight = function variableBarHeight(d) {
        return variableHeight ? d.n / totalN * height : fixedBarHeight;
      };

      var variableBarPad = function variableBarPad(i) {
        if (!variableHeight) {
      ...
      _d32["default"].select("#toggle").on("click", function () {

        variableHeight = !variableHeight;

        var trans = bar.transition().duration(1000).delay(function (d, i) {
          return i * 10;
        }).attr("transform", function (d, i) {
          return "translate(0," + variableBarPad(i) + ")";
        });
...
exports["default"] = incomeChart;
module.exports = exports["default"];

},{"./curlyBrace.js":98,"d3":94,"lodash":95,"textures":96}],100:[function(require,module,exports){
'use strict';
...
var _incomeJs = require('./income.js');

var _incomeJs2 = _interopRequireDefault(_incomeJs);

/*
 * csv promise function
 */
var csv = function csv(fname) {
  return new Promise(function (resolve, reject) {
    d3.csv(fname, function (e, data) {
...
function render() {
  var data, _data, income, percent, expected, plots, draw;
  ...
  return regeneratorRuntime.async(function render$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      ...
      case 2:
        ...
        percent = _data[1];
        expected = _data[2];
        plots = [new _incomeJs2['default']({ data: income, id: '#chart' })];

        draw = function draw(x) {
          return x.draw();
        };
